  ...
  return (
    ...
    >
      <div
        ...
        style={{
          width: `calc(${width}px + clamp(50px, 12vw, 140px))`,
          height: `calc(${height}px + clamp(50px, 12vw, 140px))`,
        }}
      >
        ...
        <div className="absolute inset-[30px] md:inset-[70px] overflow-hidden bg-black shadow-[0_0_50px_rgba(0,0,0,0.8)]">
          ...
          <Image
            ...
            width={width}
            height={height}
            className={`object-cover w-full h-full transition-all duration-1000 group-hover:scale-110 ${isLoaded ? "opacity-90 contrast-125 saturate-[0.85]" : "opacity-10"}`}
      ...
      <div className="mt-8 px-4 py-3 bg-transparent transition-all duration-1000 min-w-[200px]">
        <div className="flex flex-col items-center gap-1.5 text-center">
          ...
          <div className="text-[11px] md:text-[12px] tracking-[0.6em] text-[#d4af37] font-serif uppercase font-light leading-relaxed">
            {title}
          </div>
          
          <div className="flex items-center gap-3 w-full">
            <div className="h-[0.5px] flex-1 bg-gradient-to-r from-transparent to-[#8e6d13]/40" />
            <div className="text-[8px] tracking-[0.4em] text-[#8e6d13] font-serif uppercase opacity-80 italic">
              {year}
            </div>
            <div className="h-[0.5px] flex-1 bg-gradient-to-l from-transparent to-[#8e6d13]/40" />
          </div>
          
          <div className="text-[7px] tracking-[0.3em] text-[#59421a] font-serif uppercase opacity-60">
